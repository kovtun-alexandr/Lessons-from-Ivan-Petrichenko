...
const personalMovieDB = {
  ...
  writeYourGenres: function() {
    ...
    //     i--;
    //   } else {
    //     personalMovieDB.genrers[i - 1] = genre;
    //   }
    // }

    // Способ №2
    for (let i = 1; i < 2; i++) {
      let genres = prompt(`Введите ваши любимые жанры чкрез запятую`,'');
      if (genres === '' || genres == null) {
        console.log('Вы ввели не коректные данные или не ввели их вовсе');
      } else {
        personalMovieDB.genrers = genres.split(', ');
      }
    }

    personalMovieDB.genrers.forEach((item, i) => {
